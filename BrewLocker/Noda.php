...
$stmt= $db->prepare("SELECT beer_name FROM beers WHERE brewery_ID=351960");
$stmt->execute();

$stmt2= $db->prepare("SELECT abv FROM beers WHERE brewery_ID=351960");
$stmt2->execute();

$stmt3= $db->prepare("SELECT beer_description FROM beers WHERE brewery_ID=351960");
$stmt3->execute();

$stmt4= $db->prepare("SELECT beer_ID FROM beers WHERE brewery_ID=351960");
$stmt4->execute();
...
<head>
    ...
    <!-- Document Title
    ============================================= -->
    <title>NoDa Brewing Company | Brew Locker</title>
...
<div id="wrapper" class="clearfix">
    ...
    <section id="page-title" class="page-title-pattern">
        ...
        <div class="container clearfix">
            ...
            <h1>NoDa Brewing Company</h1>
            <span>2921 N Tryon St, Charlotte, NC 28206</span>
            <ol class="breadcrumb">
                <li><a href="index.php">Home</a></li>
                <li class="active">NoDa Brewing Company</li>
            </ol>
        </div>
