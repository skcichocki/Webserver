...
$stmt= $db->prepare("SELECT beer_name FROM beers WHERE brewery_ID=548421");
$stmt->execute();

$stmt2= $db->prepare("SELECT abv FROM beers WHERE brewery_ID=548421");
$stmt2->execute();

$stmt3= $db->prepare("SELECT beer_description FROM beers WHERE brewery_ID=548421");
$stmt3->execute();

$stmt4= $db->prepare("SELECT beer_ID FROM beers WHERE brewery_ID=548421");
$stmt4->execute();
...
<head>
    ...
    <!-- Document Title
    ============================================= -->
    <title>Sugar Creek Brewing Company | Brew Locker</title>
...
<div id="wrapper" class="clearfix">
    ...
    <section id="page-title" class="page-title-pattern">
        ...
        <div class="container clearfix">
            <img src="images/brewery/sugarcreek.jpg" class="alignleft  img-thumbnail notopmargin nobottommargin" alt="Avatar" style="max-width: 84px;">
            <h1>Sugar Creek Brewing Company</h1>
            <span>215 Southside Dr, Charlotte, NC 28217</span>
            <ol class="breadcrumb">
                <li><a href="index.php">Home</a></li>
                <li class="active">Sugar Creek Brewing Company</li>
            </ol>
        </div>
