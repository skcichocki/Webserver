...
$stmt= $db->prepare("SELECT beer_name FROM beers WHERE brewery_ID=567839");
$stmt->execute();

$stmt2= $db->prepare("SELECT abv FROM beers WHERE brewery_ID=567839");
$stmt2->execute();

$stmt3= $db->prepare("SELECT beer_description FROM beers WHERE brewery_ID=567839");
$stmt3->execute();

$stmt4= $db->prepare("SELECT beer_ID FROM beers WHERE brewery_ID=567839");
$stmt4->execute();
...
$brewery = "Wicked Weed Brewing Pub";
...
<head>
    ...
    <!-- Document Title
    ============================================= -->
    <title>Wicked Weed Brewing Pub | Brew Locker</title>
...
<div id="wrapper" class="clearfix">
    ...
    <section id="page-title" class="page-title-pattern">
        ...
        <div class="container clearfix">
            <img src="images/brewery/wicked.jpg" class="alignleft  img-thumbnail notopmargin nobottommargin" alt="Avatar" style="max-width: 84px;">
            <h1>Wicked Weed Brewing Pub</h1>
            <span>91 Biltmore Ave, Asheville, NC 28801</span>
            <ol class="breadcrumb">
                <li><a href="index.php">Home</a></li>
                <li class="active">Wicked Weed Brewing Pub</li>
            </ol>
        </div>
