...
<div id="wrapper" class="clearfix">
    ...
    <section id="slider" class="force-full-screen full-screen">
        ...
        <div class="force-full-screen full-screen dark" style="background-image: url('images/Beer1.jpg');background-position: 50% 0;">

            <div class="container clearfix">
                <div class="slider-caption slider-caption-center">
                    <h2 data-animate="fadeInDown">Welcome To Brew Locker Charlotte</h2>
                    <p data-animate="fadeInLeft" data-delay="400">This website was created as a project by 2 classmates. There has been upkeep since the project end. There have been some improvements since, as well as hardware changes.</p>
