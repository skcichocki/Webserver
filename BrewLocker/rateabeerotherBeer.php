...
$stmt= $db->prepare("SELECT brewery_ID FROM breweries WHERE brewery_Name='$brewery'");
$stmt->execute();
$id=$stmt->fetchColumn();
...
<div id="wrapper" class="clearfix">
    ...
    <section id="page-title" class="page-title-pattern">
        ...
        <div class="container clearfix">
            <h1>Rate A Beer</h1>
            <span><b><?php echo $brewery; ?></b></span>
        ...
        <div class="content-wrap">
            ...
            <div class="container clearfix">
                ...
                <div class=" nobottommargin">
                        ...
                        <form class="nobottommargin" id="beer" name="beer" action="rateabeerotherRate.php" method="post">

                            <div class="form-process"></div>

                            <?php
                            $ops='';
                            $pdo = new PDO('mysql:host=localhost;dbname=brew_locker', 'root', 'goodwill');
                            $stmt = $pdo->query("SELECT beer_name FROM beers WHERE brewery_ID='$id'");
                            //$stmt = $pdo->execute();
                            while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                $ops.= "<option value='" . $row['beer_name'] . "'>" . $row['beer_name'] . "</option>";
                            }
                            ?>

                            <div class="col_one_third">
                                <label >Beer From <?php echo $brewery; ?><small> *</small></label>
                                <select  name="beer" class="sm-form-control">
                                    <?php echo $ops;?>
                            ...
                            <div class="col_full">
                                <button class="button button-3d nomargin" type="submit" id="template-contactform-submit" name="template-contactform-submit" value="submit">Next</button>
                            </div>
