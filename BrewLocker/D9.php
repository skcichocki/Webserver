...
$stmt= $db->prepare("SELECT beer_name FROM beers WHERE brewery_ID=750667");
$stmt->execute();

$stmt2= $db->prepare("SELECT abv FROM beers WHERE brewery_ID=750667");
$stmt2->execute();

$stmt3= $db->prepare("SELECT beer_description FROM beers WHERE brewery_ID=750667");
$stmt3->execute();

$stmt4= $db->prepare("SELECT beer_ID FROM beers WHERE brewery_ID=750667");
$stmt4->execute();
...
<head>
    ...
    <!-- Document Title
    ============================================= -->
    <title>D9 Brewing Company | Brew Locker</title>
...
<div id="wrapper" class="clearfix">
    ...
    <section id="page-title" class="page-title-pattern">
        ...
        <div class="container clearfix">
            ...
            <h1>D9 Brewing Company</h1>
            <span>11138 Treynorth Dr, Cornelius, NC 28031</span>
            <ol class="breadcrumb">
                <li><a href="index.php">Home</a></li>
                <li class="active">D9 Brewing Company</li>
            </ol>
        </div>
