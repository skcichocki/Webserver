...
$stmt= $db->prepare("SELECT beer_name FROM beers WHERE brewery_ID=654987");
$stmt->execute();

$stmt2= $db->prepare("SELECT abv FROM beers WHERE brewery_ID=654987");
$stmt2->execute();

$stmt3= $db->prepare("SELECT beer_description FROM beers WHERE brewery_ID=654987");
$stmt3->execute();

$stmt4= $db->prepare("SELECT beer_ID FROM beers WHERE brewery_ID=654987");
$stmt4->execute();
...
<head>
    ...
    <!-- Document Title
    ============================================= -->
    <title>Cabarrus Brewing Company | Brew Locker</title>
...
<div id="wrapper" class="clearfix">
    ...
    <section id="page-title" class="page-title-pattern">
        ...
        <div class="container clearfix">
            ...
            <h1>Cabarrus Brewing Company</h1>
            <span>329 McGill Ave NW, Concord, NC 28027</span>
            <ol class="breadcrumb">
                <li><a href="index.php">Home</a></li>
                <li class="active">Cabarrus Brewing Company</li>
            </ol>
        </div>
