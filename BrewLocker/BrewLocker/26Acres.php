...
$stmt= $db->prepare("SELECT beer_name FROM beers WHERE brewery_ID=357412");
$stmt->execute();

$stmt2= $db->prepare("SELECT abv FROM beers WHERE brewery_ID=357412");
$stmt2->execute();

$stmt3= $db->prepare("SELECT beer_description FROM beers WHERE brewery_ID=357412");
$stmt3->execute();

$stmt4= $db->prepare("SELECT beer_ID FROM beers WHERE brewery_ID=357412");
$stmt4->execute();
...
<head>
    ...
    <!-- Document Title
    ============================================= -->
    <title>Twenty-Six Acres Brewing Company | Brew Locker</title>
...
<div id="wrapper" class="clearfix">
    ...
    <section id="page-title" class="page-title-pattern">
        ...
        <div class="container clearfix">
            <img src="images/brewery/26.jpg" class="alignleft  img-thumbnail notopmargin nobottommargin" alt="Avatar" style="max-width: 84px;">
            <h1>Twenty-Six Acres Brewing Company</h1>
            <span>7285 W Winds Blvd NW, Concord, NC 28027</span>
            <ol class="breadcrumb">
                <li><a href="index.php">Home</a></li>
                <li class="active">Twenty-Six Acres Brewing Company</li>
            </ol>
        </div>
