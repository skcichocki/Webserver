...
$stmt= $db->prepare("SELECT beer_name FROM beers WHERE brewery_ID=254896");
$stmt->execute();

$stmt2= $db->prepare("SELECT abv FROM beers WHERE brewery_ID=254896");
$stmt2->execute();

$stmt3= $db->prepare("SELECT beer_description FROM beers WHERE brewery_ID=254896");
$stmt3->execute();

$stmt4= $db->prepare("SELECT beer_ID FROM beers WHERE brewery_ID=254896");
$stmt4->execute();
...
<head>
    ...
    <!-- Document Title
    ============================================= -->
    <title>Blue Blaze Brewing | Brew Locker</title>
...
<div id="wrapper" class="clearfix">
    ...
    <section id="page-title" class="page-title-pattern">
        ...
        <div class="container clearfix">
            <img src="images/brewery/blueblaze.png" class="alignleft  img-thumbnail notopmargin nobottommargin" alt="Avatar" style="max-width: 84px;">
            <h1>Blue Blaze Brewing</h1>
            <span>528 S Turner Ave, Charlotte, NC 28208,</span>
            <ol class="breadcrumb">
                <li><a href="index.php">Home</a></li>
                <li class="active">Blue Blaze Brewing</li>
            </ol>
        </div>
