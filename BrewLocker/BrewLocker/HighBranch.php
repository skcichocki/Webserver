...
$stmt= $db->prepare("SELECT beer_name FROM beers WHERE brewery_ID=987654");
$stmt->execute();

$stmt2= $db->prepare("SELECT abv FROM beers WHERE brewery_ID=987654");
$stmt2->execute();

$stmt3= $db->prepare("SELECT beer_description FROM beers WHERE brewery_ID=987654");
$stmt3->execute();

$stmt4= $db->prepare("SELECT beer_ID FROM beers WHERE brewery_ID=987654");
$stmt4->execute();
...
$brewery = "High Branch Brewing Co.";
...
<head>
    ...
    <!-- Document Title
    ============================================= -->
    <title>High Branch Brewing Co. | Brew Locker</title>
...
<div id="wrapper" class="clearfix">
    ...
    <section id="page-title" class="page-title-pattern">
        ...
        <div class="container clearfix">
            <img src="images/brewery/birdsong.gif" class="alignleft  img-thumbnail notopmargin nobottommargin" alt="Avatar" style="max-width: 84px;">
            <h1>High Branch Brewing Co.</h1>
            <span>325 McGill Ave NW #148, Concord, NC 28027</span>
            <ol class="breadcrumb">
                <li><a href="index.php">Home</a></li>
                <li class="active">High Branch Brewing Co.</li>
            </ol>
        </div>
