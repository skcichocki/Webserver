            ...
            <div class="container clearfix">
                ...
                <div class="col_one_third nobottommargin">
                    ...
                    <div class="well well-lg nobottommargin">
                        <form id="login" name="login" class="nobottommargin" action="login_action.php" method="post">

                            <h3>Login to your Account</h3>

                            <div class="col_full">
                                <label>Username:</label>
                                <input required type="text" id="username" name="username" value="" class="form-control" />
                            </div>
                ...
                <div class="col_two_third col_last nobottommargin">
                    ...
                    <p>This registration form is to be used by normal users only. If you are a new Brewery and would like to create a brewery profile, please click <a href = "#">here</a>!</p>

                    <form id="register" name="register" class="nobottommargin" action="register_action.php" method="post">

                        <div class="col_half">
                            <label for="register-form-name">* First Name:</label>
                            <input required type="text" id="fname" name="fname" value="" class="form-control" />
                        </div>

                        <div class="col_half col_last">
                            <label for="register-form-email">* Last Name:</label>
                            <input required type="text" id="lname" name="lname" value="" class="form-control" />
                        </div>
                        ...
                        <div class="col_full nobottommargin">
                            <button class="button button-3d button-black nomargin" id="submit" name="submit" type="submit" value="register">Register Now</button>
                        </div>
