...
$stmt= $db->prepare("SELECT beer_name FROM beers WHERE brewery_ID=159753");
$stmt->execute();

$stmt2= $db->prepare("SELECT abv FROM beers WHERE brewery_ID=159753");
$stmt2->execute();

$stmt3= $db->prepare("SELECT beer_description FROM beers WHERE brewery_ID=159753");
$stmt3->execute();

$stmt4= $db->prepare("SELECT beer_ID FROM beers WHERE brewery_ID=159753");
$stmt4->execute();
...
$brewery = "Red Hill Brewing Company";
...
<head>
    ...
    <!-- Document Title
    ============================================= -->
    <title>Red Hill Brewing Company | Brew Locker</title>
...
<div id="wrapper" class="clearfix">
    ...
    <section id="page-title" class="page-title-pattern">
        ...
        <div class="container clearfix">
            ...
            <h1>Red Hill Brewing Company</h1>
            <span>20 Church St S, Concord, NC 28025</span>
            <ol class="breadcrumb">
                <li><a href="index.php">Home</a></li>
                <li class="active">Red Hill Brewing Company</li>
            </ol>
        </div>
