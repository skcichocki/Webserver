...
$location = "Wooden Robot Brewery.php";
...
$stmt= $db->prepare("SELECT beer_name FROM beers WHERE brewery_ID=357951");
$stmt->execute();

$stmt2= $db->prepare("SELECT abv FROM beers WHERE brewery_ID=357951");
$stmt2->execute();

$stmt3= $db->prepare("SELECT beer_description FROM beers WHERE brewery_ID=357951");
$stmt3->execute();

$stmt4= $db->prepare("SELECT beer_ID FROM beers WHERE brewery_ID=357951");
$stmt4->execute();
...
<head>
    ...
    <!-- Document Title
    ============================================= -->
    <title>Wooden Robot Brewery | Brew Locker</title>
...
<div id="wrapper" class="clearfix">
    ...
    <section id="page-title" class="page-title-pattern">
        ...
        <div class="container clearfix">
            <img src="images/brewery/woodenrobot.jpg" class="alignleft  img-thumbnail notopmargin nobottommargin" alt="Avatar" style="max-width: 84px;">
            <h1>Wooden Robot Brewery</h1>
            <span>1440 S Tryon St #110, Charlotte, NC 28203</span>
            <ol class="breadcrumb">
                <li><a href="index.php">Home</a></li>
                <li class="active">Wooden Robot Brewery</li>
            </ol>
        </div>
