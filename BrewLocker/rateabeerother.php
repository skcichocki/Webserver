...
<div id="wrapper" class="clearfix">
    ...
    <section id="page-title" class="page-title-pattern">
        ...
        <div class="container clearfix">
            <h1>Rate A Beer</h1>
            <span><b>Select a Brewery</b></span>
            ...
            <div class="container clearfix">
                ...
                <div class=" nobottommargin">
                    ...
                    <div class="nobottompadding">
                        ...
                        <form class="nobottommargin" id="rateabeerother" name="rateabeerother" action="rateabeerotherBeer.php" method="post">
                            ...
                            $stmt = $pdo->query("SELECT brewery_name FROM breweries");
                            //$stmt = $pdo->execute();
                            while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                $ops.= "<option value='" . $row['brewery_name'] . "'>" . $row['brewery_name'] . "</option>";
                            }
                            ?>

                            <div class="col_one_third">
                                <label>Brewery Name<small> *</small></label>
                                <select  name="brewery" class="sm-form-control">
                                    <?php echo $ops;?>
                                </select>
                            </div>
                            ...
                            <div class="col_full">
                                <button class="button button-3d nomargin" type="submit" id="submit" name="submit" value="submit">Next</button>
                            </div>
