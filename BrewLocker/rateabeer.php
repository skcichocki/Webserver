...
<head>
    ...
    <!-- Document Title
    ============================================= -->
    <title>Brew Locker | Rate <?php echo $name;?></title>
...
<div id="wrapper" class="clearfix">
    ...
    <section id="page-title" class="page-title-pattern">
        ...
        <div class="container clearfix">
            <h1>You are about to rate...</h1>
            <span><?php echo $brewery;?> <b><?php echo $name;?></b></span>
            <span><b></b></span>
            <ol class="breadcrumb">
        ...
        <div class="content-wrap">
            ...
            <div class="container clearfix">
                ...
                <div class=" nobottommargin">
                        ...
                        <form class="nobottommargin" id="template-contactform" name="template-contactform" action="rateABeerHandler.php" method="post">

                            <div class="form-process"></div>

                            <div class="col_one_third">
                                <label for="name">Name <small>*</small></label>
                                <input readonly type="text" id="name" name="name" value="<?php echo $name;?>" class="sm-form-control required" />
                            </div>

                            <div class="col_one_third">
                                <label for="where">Where Did You Try <?php echo $name;?>? <small></small></label>
                                <input type="text"  name="where" value="" class="sm-form-control" />
                            </div>

                            <div class="col_one_third col_last">
                                <label for="when">When Did You Try <?php echo $name;?>? <small></small></label>
                            ...
                            <div class="col_one_third">
                                <label for="rate">Rate <?php echo $name;?> <small>*</small></label>
                            ...
                            <div class="col_full">
                                ...
                                <textarea class="sm-form-control" name="desc" rows="6" cols="30"></textarea>
                            </div>
