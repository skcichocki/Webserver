        ...
        <div id="header-wrap">
            ...
            <div class="container clearfix">
                ...
                <div id="logo">
                    ...
                    <a href="index.php" class="retina-logo" data-dark-logo="images/treecorner.png"><img src="images/treecorner.png" alt="Canvas Logo"></a>
                </div><!-- #logo end -->
        ...
        <div class="force-full-screen full-screen dark" style="background-image: url('images/treecorner.png'); background-position: center; background-size: auto; background-repeat: no-repeat; background-attachment: fixed;">
            ...
            <div class="container clearfix">
                <div class="slider-caption slider-caption-center">
                    <h2 data-animate="fadeInDown">Kyle and Jessica Wedding Directory!</h2>
                    <p data-animate="fadeInUp" data-delay="400">Use the links at the top to navigate </p>
    ...
    <footer id="footer" class="dark">
        ...
        <div id="copyrights">
            ...
            <div class="container clearfix">
                ...
                <div class="col_half">
                    Copyrights &copy; 2018 All Rights Reserved by Sagan Cichocki<br>
                </div>
