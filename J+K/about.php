    ...
    <header id="header" class="transparent-header dark full-header no-sticky">
        ...
        <div id="header-wrap">
            ...
            <div class="container clearfix">
                ...
                ============================================= -->
                <div id="logo">
                    <a href="index.php" class="standard-logo" data-dark-logo="images/treecorner.png"><img src="images/beerlogo.png" alt="Canvas Logo"></a>
                    <a href="index.php" class="retina-logo" data-dark-logo="images/treecorner.png"><img src="images/beerlogo.png" alt="Canvas Logo"></a>
                </div><!-- #logo end -->
    ...
    <footer id="footer" class="dark">
        ...
        <div id="copyrights">
            ...
            <div class="container clearfix">
                ...
                <div class="col_half">
                    Copyrights &copy; 2018 All Rights Reserved by Sagan<br>
                </div>
