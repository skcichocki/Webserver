...
//
//$stmt= $db->prepare("SELECT beer_name FROM beers WHERE brewery_ID=484707");
//$stmt->execute();
//
//$stmt2= $db->prepare("SELECT abv FROM beers WHERE brewery_ID=484707");
//$stmt2->execute();
//
//$stmt3= $db->prepare("SELECT beer_description FROM beers WHERE brewery_ID=484707");
//$stmt3->execute();
//
//$stmt4= $db->prepare("SELECT beer_ID FROM beers WHERE brewery_ID=484707");
//$stmt4->execute();
//
    ...
    <header id="header" class="full-header">
        ...
        <div id="header-wrap">
            ...
            <div class="container clearfix">
                ...
                ============================================= -->
                <div id="logo">
                    <a href="index.php" class="standard-logo" data-dark-logo="images/treecorner.png"><img src="images/treecorner.png" alt="Canvas Logo"></a>
                    <a href="index.php" class="retina-logo" data-dark-logo="images/treecorner.phg"><img src="images/treecorner.png" alt="Canvas Logo"></a>
                </div><!-- #logo end -->
                ...
                <nav id="primary-menu">
                    ...
                    <ul>
                        ...
                        <li class="current"><a href="locate.php"><div>Location</div></a></li>
...
<!--                        <li><a href="about.php"><div>About</div></a> </li>-->
    ...
    <section id="page-title" class="page-title-pattern">
        ...
        <div class="container clearfix">
<!--            <img src="images/brewery/ass.jpg" class="alignleft  img-thumbnail notopmargin nobottommargin" alt="Avatar" style="max-width: 84px;">-->
            <h1>Location</h1>
            <span>280 Edmiston Rd, Mt Ulla, NC 28125</span>
    ...
    ============================================= -->
    <section id="content">
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3243.164823932326!2d-80.75101458474279!3d35.623662980207726!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8853feeb595695e5%3A0x52d07c23c7d1f4e2!2s280+Edmiston+Rd%2C+Mt+Ulla%2C+NC+28125!5e0!3m2!1sen!2sus!4v1544107642585" width="400" height="300" frameborder="0" style="border:0" allowfullscreen></iframe>
